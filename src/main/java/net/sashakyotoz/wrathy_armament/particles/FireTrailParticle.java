...
public class FireTrailParticle extends WaveParticle {

    public FireTrailParticle(ClientLevel world, double x, double y, double z, List<Float> movementVector, List<Float> colorList, SpriteSet spriteset) {
    ...
    public static class FireTrailParticleProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType typeIn, @NotNull ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new FireTrailParticle(worldIn, x, y, z,List.of((float)xSpeed,(float)ySpeed,(float)zSpeed),List.of(1f,1f,1f), this.spriteSet);
        }
    }
}
