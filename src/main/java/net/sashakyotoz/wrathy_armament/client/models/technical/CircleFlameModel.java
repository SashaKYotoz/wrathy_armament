...
public class CircleFlameModel extends Model {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(WrathyArmament.createWALocation("circle_flame_model"), "main");
    private final ModelPart flame;

    public CircleFlameModel(ModelPart root) {
