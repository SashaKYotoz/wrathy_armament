...
public class WrathyArmamentItems {
    ...
    public static final RegistryObject<Item> MIRROR_SWORD = ITEMS.register("mirror_sword",()-> new MirrorSword(new Item.Properties().rarity(ModRarity.LEGENDARY_RARITY).fireResistant().stacksTo(1).durability(3200).fireResistant()));
    //materials
