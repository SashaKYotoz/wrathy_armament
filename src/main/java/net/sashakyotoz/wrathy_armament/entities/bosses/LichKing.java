...
import net.sashakyotoz.wrathy_armament.entities.ai_goals.bosses.LichKingAttackGoal;
import net.sashakyotoz.wrathy_armament.entities.ai_goals.bosses.LichKingRangedAttackGoal;
